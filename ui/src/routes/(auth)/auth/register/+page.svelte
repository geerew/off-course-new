...
<div class="flex h-full min-h-110 flex-col items-center justify-center gap-8">
	...
	<div class="flex min-w-sm flex-col gap-5">
		<div class="mb-2.5 flex flex-col gap-2">
			<div class="text-foreground-alt text-center text-lg">Create an account</div>
		</div>
		...
		<div class="text-muted-foreground text-center">
			...
			<a href="/auth/login/" class="hover:text-primary-background font-semibold duration-200">
				Login
			</a>
		</div>
	</div>
