<script lang="ts">
	...
	import { AddCourseTag, GetTag, GetTags } from '$lib/api';
	...
	// The list of course IDs to which the tags will be added
...
{#if isOpen}
	...
	<!-- Body -->
	<main
		class="flex max-h-[20rem] min-h-[8rem] flex-col gap-2 overflow-hidden overflow-y-auto px-4"
		data-vaul-no-drag=""
	>
